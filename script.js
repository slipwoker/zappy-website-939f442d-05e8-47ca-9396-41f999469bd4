  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      ...
      const messages = {
        ...
        minLength: 'Please enter at least ' + (field.dataset.minLength || '2') + ' characters.',
  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        if (node.nodeType === 1) {
          if (node.matches && node.matches(ANIMATION_SELECTOR)) {
            initScrollAnimations();
          } else if (node.querySelectorAll) {
            const children = node.querySelectorAll(ANIMATION_SELECTOR);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '939f442d-05e8-47ca-9396-41f999469bd4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '939f442d-05e8-47ca-9396-41f999469bd4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '939f442d-05e8-47ca-9396-41f999469bd4';
